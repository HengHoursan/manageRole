...
import {
    Table, TableHeader, TableBody, TableCell, TableRow, TableHead,
...
import {getAllProducts, createNewProduct, updateProduct, deleteProduct} from "../api/productAction";
...
const Product = () => {
    ...
    const form = useForm({
        defaultValues: {
            productName: "", description: "", price: "", category: "", image: null,
        },
    });
    ...
    const handleCloseProductDialog = () => {
        ...
        form.reset({
            productName: "", description: "", price: (0).toFixed(2), category: "", image: null,
        });
    };
    return (<>
        {/* Overlay Loader */}
        ...
        <Card className="mb-4">
            ...
            <CardContent className="p-0">
                <Table>
                    ...
                    <TableBody>
                        {proudctData.length === 0 ? (<TableRow>
                            <TableCell colSpan={8} className="text-center py-6 text-gray-500">
                                No products found.
                            </TableCell>
                        </TableRow>) : (proudctData.map((product, index) => (<TableRow key={product.id}>
                            ...
                            <TableCell>
                                {product.image ? (<img
                                    ...
                                    onError={() => {
                                        ...
                                        console.log("Image URL:", `${BASE_URL}/${product.image.replace(/\\/g, "/")}`);
                                    }}
                    ...
                    <form className="space-y-4 pt-2">
                        ...
                        <FormField
                            ...
                            render={({field}) => (<FormItem>
                                ...
                                <FormControl>
                                    <Input type="number" placeholder="Enter price" {...field} min={0} step="0.25"/>
                                </FormControl>
                            </FormItem>)}
                        />
                        <FormField
                            ...
                            render={({field}) => (<FormItem>
                                ...
                                <FormControl>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            {categoryData.map((cat) => (<SelectItem key={cat.id} value={cat.id}>
                                                {cat.name}
                                            </SelectItem>))}
                                        </SelectContent>
                                    </Select>
                        ...
                        <DialogFooter className="pt-2">
                            <DialogClose asChild>
                                <Button type="button" variant="ghost" onClick={handleCloseProductDialog}>
                                    Cancel
                                </Button>
                            </DialogClose>
                            <Button
