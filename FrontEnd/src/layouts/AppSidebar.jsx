...
const menuItems = [{title: "Home", url: "/layout", icon: Home}, {
    title: "Products",
    url: "/layout/products",
    icon: Package
...
const AppSidebar = () => {
    ...
    return (<Sidebar className="flex flex-col justify-between h-full">
            {/* Header Section */}
            <SidebarHeader>
                    ...
                    <SidebarGroupContent>
                        <SidebarMenu>
                            {menuItems.map((item) => {
                                ...
                                return (<SidebarMenuItem key={item.title} data-active={isActive}>
