...
const Login = () => {
  ...
  // Custom handler for Mini App login
    ...
    <div className="flex items-center justify-center min-h-screen">
      <Card className="w-full max-w-sm bg-white text-black">
        ...
        <CardFooter className="flex flex-col">
          ...
          {/* Universal Telegram Login Button */}
          <div className="flex justify-center items-center w-full min-h-[50px]">
            {isWebApp ? (
              /* Custom Look-alike Button for Mini App (fixes "Bot domain invalid") */
              <Button
                onClick={handleWebAppLogin}
                className="w-[180px] bg-[#54A9EB] hover:bg-[#4ea2e0] text-white flex items-center justify-center gap-2 rounded-lg h-[40px] text-[14px] font-medium transition-colors"
              >
                <svg
              ...
              /* Official Widget for Standalone Browsers */
